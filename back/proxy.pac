/*
** automatic proxy configuration V2.1 for 10.136.144.235 from proxyconf.glb.nsn-net.net (10.158.52.17)
*/
function FindProxyForURL(url, host) {
 var proxy="PROXY phquprx100.apac.nsn-net.net:8080; PROXY cnhon1c-proxy.apac.nsn-net.net:8080;";
...
if (host == 'r3.res.outlook.com') return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';
if (host == 'nsnsiacc.service-now.com') return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';
if (host == 'nsnsi.service-now.com') return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';
if (host == "eu-p.serviceportal.hp.com") { return "PROXY 135.7.146.1:8000;PROXY 135.7.178.1:8000;PROXY 135.7.210.1:8000"; }
if (host == "eifprodweb01.alucloud.com") { return "PROXY 135.7.146.1:8000;PROXY 135.7.178.1:8000;PROXY 135.7.210.1:8000"; }
if (host == 'performancemanager5.successfactors.eu') {return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (host == 'cmp.nsn.com') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (host == '192.194.198.4') { return 'PROXY fiesprx-demuprx.glb.nsn-net.net:8080';}
if (host == '192.194.198.7') { return 'PROXY fiesprx-demuprx.glb.nsn-net.net:8080';}
if (host == '192.194.198.68') { return 'PROXY fiesprx-demuprx.glb.nsn-net.net:8080';}
if (host == 'fidm.access.it-solutions.atos.net') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (host == 'eu1.concursolutions.com') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (shExpMatch(host,'*myrealestate.ext.nokia.com')) {return 'PROXY defraprx-fihelprx.glb.nsn-net.net:8080';}
if (host == 'www.alcatel-sbell.com.cn') { return 'PROXY cnbeprx-cnshprx.glb.nsn-net.net:8080';}
if (host == 'r1.res.office365.com') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (host == 'r3.res.office365.com') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (host == 'r4.res.office365.com') { return 'PROXY fihelprx-defraprx.glb.nsn-net.net:8080';}
if (shExpMatch(host,'85.182.208.*')) { return 'PROXY 10.144.1.10:8080';}
...
if (host == 'nokia.kronos.net') { return 'PROXY 10.158.100.3:8080';}
 ...
 if ( dnsDomainIs(host, ".webcasts.com") ) { dnsResolve(host+'.bf.nsn-intra.net'); return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "192.11.97.233","255.255.255.255") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "192.11.34.14","255.255.255.255") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "159.217.144.80","255.255.255.255") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "135.250.138.206","255.255.255.255") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "159.217.150.24","255.255.255.248") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "192.11.79.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "192.11.69.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "192.11.200.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "192.11.161.0","255.255.255.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "138.35.45.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "138.35.44.0","255.255.255.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "138.120.70.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "138.120.68.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.109.24.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.109.237.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.104.9.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.104.2.0","255.255.255.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.104.20.0","255.255.255.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "135.121.242.0","255.255.254.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.115.128.0","255.255.254.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "131.228.56.0","255.255.254.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "131.228.2.0","255.255.254.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "135.121.108.0","255.255.252.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "159.217.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "159.216.0.0","255.255.0.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "135.185.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.184.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.183.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.181.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.18.0.0","255.255.0.0") ) { return "DIRECT"; }
 if ( isInNet(resolved_host, "135.180.0.0","255.255.0.0") ) { return "DIRECT"; }
